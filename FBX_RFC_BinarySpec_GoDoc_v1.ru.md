...
| 1..31 | RESERVED | Для v1 writers MUST быть 0 |
...
- Зарезервированные поля MUST быть нулями у v1 writers.
- Будущие версии могут добавить:
  - регион журнала (HAS_JOURNAL) с определенной семантикой
  - резервный заголовок
  - таблицу смещений каталогов для ленивого парсинга
  - шифрование/дедупликацию/индексацию
